...
const articles = [
  {
    ...
    category: "Trading",
    article_content: `
      <h2>Introduction to IO Traders</h2>
      <p>IO Traders is a revolutionary platform designed for modern cryptocurrency traders. Whether you're a beginner or an experienced trader, this guide will help you maximize your trading potential.</p>
      
      <h3>Getting Started</h3>
      <p>Setting up your IO Traders account is straightforward. Sign up, verify your identity, and connect your wallet to begin trading.</p>
      
      <h3>Core Trading Strategies</h3>
      <ul>
        <li><strong>Day Trading:</strong> Quick trades within a single day for rapid gains</li>
        <li><strong>Swing Trading:</strong> Hold positions for days or weeks to catch market swings</li>
        <li><strong>Arbitrage:</strong> Exploit price differences across exchanges</li>
        <li><strong>Scalping:</strong> Make small frequent trades for consistent gains</li>
      </ul>
      ...
      <p>IO Traders offers advanced charting tools, real-time market analysis, and automated trading bots for experienced traders.</p>
      
      <h3>Conclusion</h3>
      <p>With proper strategy and risk management, IO Traders can be a powerful tool in your cryptocurrency trading arsenal.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>Decentralized finance offers incredible opportunities but comes with significant risks. Understanding these risks is your first line of defense.</p>
      
      <h3>Common Attack Vectors</h3>
      <ul>
        <li><strong>Smart Contract Vulnerabilities:</strong> Bugs in code can lead to fund losses</li>
        <li><strong>Rug Pulls:</strong> Developers abandon projects and steal funds</li>
        <li><strong>Flash Loans:</strong> Attackers exploit price manipulation</li>
        <li><strong>Phishing:</strong> Fraudulent websites and emails targeting users</li>
      </ul>
      ...
      <ol>
        ...
        <li>Verify URLs before connecting wallets</li>
        <li>Research projects before investing</li>
        <li>Keep seed phrases offline in multiple locations</li>
      </ol>
      
      <h3>Identifying Scams</h3>
      <p>Red flags include unrealistic returns, pressure to invest quickly, and promises of guaranteed profits. Be skeptical of any investment promising returns above market averages.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>A blockchain is a distributed ledger technology that maintains a continuously growing list of records, called blocks, which are linked using cryptography.</p>
      
      <h3>Key Components</h3>
      <ul>
        <li><strong>Blocks:</strong> Data structures containing transaction records</li>
        <li><strong>Nodes:</strong> Computers maintaining the blockchain network</li>
        <li><strong>Smart Contracts:</strong> Self-executing code on the blockchain</li>
        <li><strong>Consensus:</strong> Agreement mechanisms like Proof of Work or Proof of Stake</li>
      </ul>
      
      <h3>How Blockchain Works</h3>
      <ol>
        <li>Transactions are broadcast to the network</li>
        <li>Nodes validate transactions using consensus mechanisms</li>
        <li>Valid transactions are grouped into blocks</li>
        <li>Blocks are cryptographically linked to previous blocks</li>
        <li>The chain becomes immutable and permanent</li>
      </ol>
      
      <h3>Applications Beyond Cryptocurrency</h3>
      <p>Blockchain technology is being used in supply chain management, healthcare records, voting systems, and intellectual property protection.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      <h2>What Are NFTs?</h2>
      <p>Non-Fungible Tokens (NFTs) are unique digital assets verified on the blockchain, representing ownership of digital or physical items.</p>
      
      <h3>Getting Started with NFTs</h3>
      <ul>
        <li>Set up a cryptocurrency wallet</li>
        <li>Purchase cryptocurrency (ETH, SOL, etc.)</li>
        <li>Connect wallet to NFT marketplace</li>
        <li>Browse and purchase collections</li>
      </ul>
      
      <h3>Popular NFT Marketplaces</h3>
      <p>OpenSea, Blur, Magic Eden, and LooksRare are among the largest NFT trading platforms with diverse collections.</p>
      
      <h3>Investment Considerations</h3>
      <ol>
        <li>Understand project fundamentals and team</li>
        <li>Check transaction history and floor prices</li>
        <li>Be aware of gas fees and transaction costs</li>
        <li>Diversify your NFT holdings</li>
        <li>Store valuable NFTs in secure wallets</li>
      </ol>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>Ethereum's main network can process only 15 transactions per second, creating congestion and high gas fees. Layer 2 solutions offer an answer.</p>
      
      <h3>Types of Layer 2 Solutions</h3>
      <ul>
        <li><strong>Rollups:</strong> Bundle transactions and post to Ethereum (Optimistic and ZK)</li>
        <li><strong>Sidechains:</strong> Independent blockchains with their own validators</li>
        <li><strong>Payment Channels:</strong> Off-chain transactions between parties</li>
        <li><strong>Plasma:</strong> Hierarchical chains with periodic checkpoints</li>
      </ul>
      
      <h3>Popular Layer 2s</h3>
      <p>Arbitrum, Optimism, zkSync, Polygon, and StarkNet are leading Layer 2 solutions with significant DeFi activity and TVL.</p>
      
      <h3>Advantages</h3>
      <ol>
        <li>Significantly lower gas fees (90-99% reduction)</li>
        <li>Faster transaction confirmation</li>
        <li>Increased throughput capacity</li>
        <li>Maintained Ethereum security guarantees</li>
      </ol>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>A smart contract audit is a comprehensive review of contract code by security experts to identify vulnerabilities and potential exploits.</p>
      
      <h3>Common Vulnerabilities Found</h3>
      <ul>
      ...
      <h3>Reading Audit Reports</h3>
      <p>Look for audit firms' reputation, number of findings, severity levels, and remediation status. Multiple audits from reputable firms provide better assurance.</p>
      
      <h3>Top Audit Firms</h3>
      <p>OpenZeppelin, Chainalysis, Trail of Bits, and ConsenSys are among the most respected smart contract audit providers in the industry.</p>
    `,
  ...
  },
  {
    ...
    category: "Trading",
    article_content: `
      <h2>Understanding Arbitrage</h2>
      <p>Arbitrage involves buying an asset on one exchange and selling it on another to profit from price differences.</p>
      
      <h3>Types of Arbitrage</h3>
      <ul>
        <li><strong>Spatial Arbitrage:</strong> Buy low on one exchange, sell high on another</li>
        <li><strong>Temporal Arbitrage:</strong> Exploit price differences over time</li>
        <li><strong>Cross-chain Arbitrage:</strong> Trade across different blockchains</li>
        <li><strong>Triangular Arbitrage:</strong> Trade three different pairs for profit</li>
      </ul>
      
      <h3>Challenges</h3>
      <ol>
        <li>Transaction fees can eliminate profits</li>
        <li>Speed is critical - prices move quickly</li>
        <li>Withdrawal limits on exchanges</li>
        <li>Regulatory and KYC requirements</li>
      </ol>
      
      <h3>Tools for Arbitrage</h3>
      <p>Automated bots, exchange APIs, and real-time price monitors help identify and execute arbitrage opportunities efficiently.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>Yield farming involves depositing cryptocurrency into smart contracts to earn rewards in the form of tokens or interest.</p>
      
      <h3>How Yield Farming Works</h3>
      <ol>
        <li>Deposit crypto into a liquidity pool</li>
        <li>Earn trading fees from pool usage</li>
        <li>Receive governance or native tokens as incentives</li>
        <li>Compound returns by re-investing</li>
      </ol>
      
      <h3>APY vs APR</h3>
      <p>APR (Annual Percentage Rate) is the simple rate, while APY (Annual Percentage Yield) accounts for compounding. Always compare APY for accurate returns.</p>
      
      <h3>Risks to Consider</h3>
      <ul>
        <li>Impermanent loss in liquidity pools</li>
        <li>Smart contract risks</li>
        <li>Slippage and trading costs</li>
        <li>Token value depreciation</li>
        <li>Rug pull risks</li>
      </ul>
      
      <h3>Optimization Tips</h3>
      <p>Monitor APYs regularly, diversify across protocols, use automated aggregators, and reinvest earnings strategically.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <ul>
        <li><strong>Hot Wallets:</strong> Online and connected to internet (convenient but higher risk)</li>
        <li><strong>Cold Wallets:</strong> Offline storage (secure but less convenient)</li>
        <li><strong>Hardware Wallets:</strong> Physical devices like Ledger and Trezor</li>
        <li><strong>Paper Wallets:</strong> Printed private keys (maximum security)</li>
        <li><strong>Custodial Wallets:</strong> Third-party custody (convenience vs control trade-off)</li>
      </ul>
      
      <h3>Wallet Selection Criteria</h3>
      <ol>
        <li>Security features and audit history</li>
        <li>Supported cryptocurrencies and tokens</li>
        <li>User interface and ease of use</li>
        <li>Backup and recovery options</li>
        <li>Multi-signature support for additional security</li>
      </ol>
      
      <h3>Custody Solutions</h3>
      <p>Coinbase Custody, Kraken Custody, and Fidelity offer institutional-grade custody for large holdings.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>The cryptocurrency market continues to mature with increasing institutional adoption and regulatory clarity.</p>
      
      <h3>Key Trends</h3>
      <ul>
        <li>Bitcoin ETF approvals driving institutional investment</li>
        <li>Layer 2 scaling solutions gaining traction</li>
        <li>Tokenization of real-world assets</li>
        <li>Regulatory frameworks becoming clearer</li>
        <li>DeFi innovation accelerating</li>
      </ul>
      
      <h3>Market Cycles</h3>
      <p>Understanding market cycles helps traders identify buying and selling opportunities. Bitcoin halving events typically influence market behavior.</p>
      
      <h3>2024 Outlook</h3>
      <ol>
        <li>Increased institutional participation</li>
        <li>Regulatory convergence globally</li>
        <li>Performance upgrades on major chains</li>
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>Staking allows cryptocurrency holders to earn rewards by participating in network validation and security.</p>
      
      <h3>How Staking Works</h3>
      <ol>
        <li>Hold cryptocurrency in a blockchain network</li>
        <li>Contribute to network consensus (Proof of Stake)</li>
        <li>Earn rewards for honest validation</li>
        <li>Receive additional tokens as incentives</li>
      </ol>
      
      <h3>Popular Staking Networks</h3>
      <ul>
        <li>Ethereum - 3-5% annual rewards</li>
        <li>Solana - 6-8% annual rewards</li>
        <li>Polkadot - 10-15% annual rewards</li>
        <li>Cosmos - 10-25% annual rewards</li>
        <li>Cardano - 4-6% annual rewards</li>
      </ul>
      
      <h3>Staking Risks</h3>
      <p>Slashing penalties, lockup periods, validator downtime, and market volatility are risks to consider when staking.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>Tokenomics refers to the economic principles and mechanics governing a cryptocurrency token's creation, distribution, and utility.</p>
      
      <h3>Key Tokenomic Factors</h3>
      <ul>
        <li><strong>Total Supply:</strong> Maximum tokens ever created</li>
        <li><strong>Circulating Supply:</strong> Tokens currently in circulation</li>
        <li><strong>Distribution:</strong> How tokens are allocated at launch</li>
        <li><strong>Inflation:</strong> New token creation over time</li>
        <li><strong>Utility:</strong> What tokens can be used for</li>
      </ul>
      
      <h3>Evaluation Criteria</h3>
      <ol>
        <li>Fair distribution avoiding excessive concentration</li>
        <li>Clear vesting schedules for team/investors</li>
        <li>Inflation mechanisms and burn mechanisms</li>
        <li>Governance capabilities for token holders</li>
        <li>Real utility beyond speculation</li>
      </ol>
      
      <h3>Red Flags</h3>
      <p>Extreme early distributions to founders, infinite supply, rapid minting, and lack of tokenomic clarity are warning signs.</p>
    `,
  ...
  },
  {
    ...
    article_content: `
      <h2>What is a DAO?</h2>
      <p>A Decentralized Autonomous Organization (DAO) is an organization represented by rules encoded as computer programs on a blockchain.</p>
      
      <h3>Governance Structure</h3>
      <ul>
        <li>Token holders vote on proposals</li>
        <li>Multi-sig wallets for fund management</li>
        <li>Smart contracts execute decisions</li>
      ...
      <ol>
        <li>Token-based voting (one token = one vote)</li>
        <li>Quadratic voting for fairness</li>
        <li>Weighted voting by stake percentage</li>
        <li>Delegation to representatives</li>
        <li>Multi-choice and ranked voting</li>
      </ol>
      
      <h3>Popular DAOs</h3>
      <p>Uniswap, Aave, Curve, and Compound are major DeFi DAOs where governance tokens determine protocol direction.</p>
    `,
  ...
  },
  {
    ...
    category: "DeFi",
    article_content: `
      <h2>The Need for Bridges</h2>
      <p>Different blockchains operate independently, creating fragmentation. Bridges enable asset transfers and communication between chains.</p>
      
      <h3>Types of Bridges</h3>
      <ul>
        <li><strong>Wrapped Bridges:</strong> Lock asset on source, mint wrapped version on destination</li>
        <li><strong>Liquidity Bridges:</strong> Use liquidity pools for swaps</li>
        <li><strong>Light Client Bridges:</strong> Verify state on both chains</li>
        <li><strong>Optimistic Bridges:</strong> Assume validity with fraud proofs</li>
      </ul>
      
      <h3>Popular Bridges</h3>
      <p>Stargate Finance, Across Protocol, and LayerZero provide decentralized cross-chain solutions with varying security models.</p>
      
      <h3>Risks and Best Practices</h3>
      <ol>
        <li>Audit status and security history</li>
        <li>Bridge TVL and liquidity</li>
        <li>Slippage and fee structures</li>
        <li>Recovery mechanisms for failures</li>
        <li>Stay informed on bridge updates</li>
      </ol>
    `,
  ...
  },
  {
    ...
    article_content: `
      ...
      <p>Liquidity mining rewards users for providing liquidity to decentralized exchanges or lending protocols.</p>
      
      <h3>How to Provide Liquidity</h3>
      <ol>
        <li>Choose a DEX or protocol</li>
        <li>Select a trading pair</li>
        <li>Deposit equal value of both assets</li>
        <li>Receive LP tokens representing your share</li>
        <li>Earn trading fees and bonus rewards</li>
      </ol>
      
      <h3>Impermanent Loss</h3>
      <p>Impermanent loss occurs when the price ratio changes, resulting in lower value than if you'd held tokens separately. Understanding this is crucial for mining.</p>
      
      <h3>Popular Liquidity Mining Programs</h3>
      <ul>
        <li>Uniswap V3 concentrated liquidity</li>
        <li>Aave liquidation mining</li>
        <li>Curve stable swap pairs</li>
        <li>Balancer protocol</li>
        <li>Velodrome on Optimism</li>
      </ul>
      
      <h3>Optimization Strategies</h3>
      <p>Focus on stable pairs to minimize impermanent loss, use concentrated liquidity for capital efficiency, and monitor APYs regularly.</p>
    `,
...
export async function seedDatabase() {
  try {
    ...
    // await supabase.from("submitted_articles").delete().neq("id", "");
    // await supabase.from("submitted_airdrops").delete().neq("id", "");
    ...
    for (const article of articles) {
      ...
      if (error) {
        ...
        console.log(`✓ Inserted article: ${article.article_title}`);
      }
    }
    ...
    for (const airdrop of airdrops) {
      ...
      if (error) {
        ...
        console.log(`✓ Inserted airdrop: ${airdrop.project_name}`);
      }
    }
